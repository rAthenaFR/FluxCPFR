	...
	<div id="footer">
		<div class="container">
			<p class="text-muted">
				...
				Propulsé par <a href="https://github.com/rathena/FluxCP" target="_blank">FluxCP</a>
				<?php endif ?>
				<?php if (Flux::config('ShowRenderDetails')): ?>
					...
					<?php if (Flux::config('GzipCompressOutput')): ?>Compression Gzip : <strong>activée</strong>.<?php endif ?>
