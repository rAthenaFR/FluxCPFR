...
<p>
	<strong>Note :</strong>
	Vous devez fournir une adresse e-mail valide pour confirmer votre compte avant de pouvoir vous connecter.
</p>
<?php endif ?>
...
<p>
	<strong>Note :</strong>
	<?php echo sprintf(
		"Votre mot de passe doit contenir entre %d et %d caractères.",
...
<form action="<?php echo $this->url ?>" method="post" class="generic-form">
	...
	<table class="generic-form-table">
		...
		<tr>
			...
			<td>
				<input
					...
					value="<?php echo htmlspecialchars($params->get('email_address') ?: '') ?>"
				/>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input
					...
					value="<?php echo htmlspecialchars($params->get('email_address2') ?: '') ?>"
				/>
			</td>
		</tr>
				...
				<p>
					<label>
						<input
							...
							value="M"<?php if ($params->get('gender') === 'M') echo ' checked="checked"' ?>
						/>
					...
					<label>
						<input
							...
							value="F"<?php if ($params->get('gender') === 'F') echo ' checked="checked"' ?>
						/>
		...
		<tr>
			...
			<td>
				<div class="no-recaptcha" style="color: red">
					<?php echo htmlspecialchars(Flux::message('AccountRecaptchaKey')) ?>
				</div>
			</td>
			<?php else: ?>
				...
				<td>
					<div class="security-code">
						<img src="<?php echo $this->url('captcha') ?>" alt="Code de sécurité" />
					</div>
