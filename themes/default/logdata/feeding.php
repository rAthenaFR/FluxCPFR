...
<form class="search-form" method="get">
	...
	<p>
		...
		...
		<label>Type de nourrissage :</label><!-- valeurs partagees -->
...
<table class="horizontal-table">
	<tr>
		<th><?php echo $paginator->sortableColumn('time', 'Heure') ?></th>
		<th><?php echo $paginator->sortableColumn('char_id', 'Char ID') ?></th>
		<th><?php echo $paginator->sortableColumn('type', 'Type') ?></th>
		<th><?php echo $paginator->sortableColumn('target_class', 'Classe cible') ?></th>
