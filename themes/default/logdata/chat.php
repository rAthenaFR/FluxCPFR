...
<table class="horizontal-table">
	<tr>
		...
		<th><?php echo $paginator->sortableColumn('type_id', 'ID de type') ?></th>
		<th><?php echo $paginator->sortableColumn('src_charid', 'Char ID') ?></th>
		<th><?php echo $paginator->sortableColumn('src_accountid', 'ID de compte') ?></th>
		<th><?php echo $paginator->sortableColumn('src_map', 'Carte') ?></th>
