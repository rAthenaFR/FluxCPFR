...
<h2>Réinitialisations de mot de passe</h2>
...
<form action="<?php echo $this->url ?>" method="get" class="search-form">
	...
	<p>
		<label for="use_reset_after">Date de réinitialisation entre :</label>
	...
	<p>
		...
		...
		<label for="reset_ip">IP de réinitialisation :</label>
...
<table class="horizontal-table">
	<tr>
		...
		<th><?php echo $paginator->sortableColumn('reset_date', 'Date de réinitialisation') ?></th>
		<th><?php echo $paginator->sortableColumn('reset_ip', 'IP de réinitialisation') ?></th>
	</tr>
...
<?php else: ?>
<p>Aucune réinitialisation de mot de passe trouvée. <a href="javascript:history.go(-1)">Retour</a>.</p>
<?php endif ?>
