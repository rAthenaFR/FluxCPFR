...
<h2>Classement des morts</h2>
<h3>
	Les <?php echo number_format($limit=(int)Flux::config('DeathRankingLimit')) ?> personnages les plus morts
...
<table class="horizontal-table">
	...
	<tr<?php if (!isset($chars[$i])) echo ' class="empty-row"'; if ($i === 0) echo ' class="top-ranked" title="<strong>'.htmlspecialchars($chars[$i]->char_name).'</strong> est le plus mort du classement '.$topRankType.' !"' ?>>
