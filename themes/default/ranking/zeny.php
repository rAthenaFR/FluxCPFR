...
<h2>Classement Zeny</h2>
<h3>
	Les <?php echo number_format($limit=(int)Flux::config('ZenyRankingLimit')) ?> personnages les plus riches
...
<table class="horizontal-table">
	...
	<tr<?php if (!isset($chars[$i])) echo ' class="empty-row"'; if ($i === 0) echo ' class="top-ranked" title="<strong>'.htmlspecialchars($chars[$i]->char_name).'</strong> est le plus riche du classement '.$topRankType.' !"' ?>>
