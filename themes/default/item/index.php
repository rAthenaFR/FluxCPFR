...
<form class="search-form" method="get">
	...
	<p>
		<label for="item_id">ID d’objet :</label>
		...
		...
		<label for="equip_loc">Emplacements d’équipement :</label>
	...
	<p>
		<label for="npc_buy">Achat PNJ :</label>
		<select name="npc_buy_op">
			<option value="eq"<?php if (($npc_buy_op=$params->get('npc_buy_op')) == 'eq') echo ' selected="selected"' ?>>est égal à</option>
			<option value="gt"<?php if ($npc_buy_op == 'gt') echo ' selected="selected"' ?>>est supérieur à</option>
			<option value="lt"<?php if ($npc_buy_op == 'lt') echo ' selected="selected"' ?>>est inférieur à</option>
		</select>
		<input type="text" name="npc_buy" id="npc_buy" value="<?php echo htmlspecialchars($params->get('npc_buy') ?: '') ?>" />
		...
		<label for="npc_sell">Vente PNJ :</label>
		<select name="npc_sell_op">
			<option value="eq"<?php if (($npc_sell_op=$params->get('npc_sell_op')) == 'eq') echo ' selected="selected"' ?>>est égal à</option>
			<option value="gt"<?php if ($npc_sell_op == 'gt') echo ' selected="selected"' ?>>est supérieur à</option>
			<option value="lt"<?php if ($npc_sell_op == 'lt') echo ' selected="selected"' ?>>est inférieur à</option>
		</select>
		<input type="text" name="npc_sell" id="npc_sell" value="<?php echo htmlspecialchars($params->get('npc_sell') ?: '') ?>" />
		...
		<label for="weight">Poids :</label>
		<select name="weight_op">
			<option value="eq"<?php if (($weight_op=$params->get('weight_op')) == 'eq') echo ' selected="selected"' ?>>est égal à</option>
			<option value="gt"<?php if ($weight_op == 'gt') echo ' selected="selected"' ?>>est supérieur à</option>
			<option value="lt"<?php if ($weight_op == 'lt') echo ' selected="selected"' ?>>est inférieur à</option>
		</select>
	...
	<p>
		...
		<select name="range_op">
			<option value="eq"<?php if (($range_op=$params->get('range_op')) == 'eq') echo ' selected="selected"' ?>>est égal à</option>
			<option value="gt"<?php if ($range_op == 'gt') echo ' selected="selected"' ?>>est supérieur à</option>
			<option value="lt"<?php if ($range_op == 'lt') echo ' selected="selected"' ?>>est inférieur à</option>
		</select>
		<input type="text" name="range" id="range" value="<?php echo htmlspecialchars($params->get('range') ?: '') ?>" />
		...
		<label for="slots">Slots :</label>
		<select name="slots_op">
			<option value="eq"<?php if (($slots_op=$params->get('slots_op')) == 'eq') echo ' selected="selected"' ?>>est égal à</option>
			<option value="gt"<?php if ($slots_op == 'gt') echo ' selected="selected"' ?>>est supérieur à</option>
			<option value="lt"<?php if ($slots_op == 'lt') echo ' selected="selected"' ?>>est inférieur à</option>
		</select>
		...
		<select name="defense_op">
			<option value="eq"<?php if (($defense_op=$params->get('defense_op')) == 'eq') echo ' selected="selected"' ?>>est égal à</option>
			<option value="gt"<?php if ($defense_op == 'gt') echo ' selected="selected"' ?>>est supérieur à</option>
			<option value="lt"<?php if ($defense_op == 'lt') echo ' selected="selected"' ?>>est inférieur à</option>
		</select>
	...
	<p>
		...
		<select name="attack_op">
			<option value="eq"<?php if (($attack_op=$params->get('attack_op')) == 'eq') echo ' selected="selected"' ?>>est égal à</option>
			<option value="gt"<?php if ($attack_op == 'gt') echo ' selected="selected"' ?>>est supérieur à</option>
			<option value="lt"<?php if ($attack_op == 'lt') echo ' selected="selected"' ?>>est inférieur à</option>
		</select>
		...
		<select name="matk_op">
			<option value="eq"<?php if (($matk_op=$params->get('matk_op')) == 'eq') echo ' selected="selected"' ?>>est égal à</option>
			<option value="gt"<?php if ($matk_op == 'gt') echo ' selected="selected"' ?>>est supérieur à</option>
			<option value="lt"<?php if ($matk_op == 'lt') echo ' selected="selected"' ?>>est inférieur à</option>
		</select>
		<input type="text" name="magic_attack" id="magic_attack" value="<?php echo htmlspecialchars($params->get('magic_attack') ?: '') ?>" />
		...
		<?php endif ?>
		<label for="refineable">Raffinable :</label>
		<select name="refineable" id="refineable">
			<option value=""<?php if (!($refineable=$params->get('refineable'))) echo ' selected="selected"' ?>>Tous</option>
			<option value="yes"<?php if ($refineable == 'yes') echo ' selected="selected"' ?>>Oui</option>
			<option value="no"<?php if ($refineable == 'no') echo ' selected="selected"' ?>>Non</option>
		</select>
		...
		<label for="for_sale">En vente :</label>
		<select name="for_sale" id="for_sale">
			<option value=""<?php if (!($for_sale=$params->get('for_sale'))) echo ' selected="selected"' ?>>Tous</option>
			<option value="yes"<?php if ($for_sale == 'yes') echo ' selected="selected"' ?>>Oui</option>
			<option value="no"<?php if ($for_sale == 'no') echo ' selected="selected"' ?>>Non</option>
		</select>
		...
...
<table class="horizontal-table">
	<tr>
		<th><?php echo $paginator->sortableColumn('item_id', 'ID d’objet') ?></th>
		<th colspan="2"><?php echo $paginator->sortableColumn('name', 'Nom') ?></th>
		<th><?php echo $paginator->sortableColumn('type', 'Type') ?></th>
		<th><?php echo $paginator->sortableColumn('subtype', 'Sous-type') ?></th>
		<th>Emplacements d’équipement</th>
		<th><?php echo $paginator->sortableColumn('price_buy', 'Achat PNJ') ?></th>
		<th><?php echo $paginator->sortableColumn('price_sell', 'Vente PNJ') ?></th>
		<th><?php echo $paginator->sortableColumn('weight', 'Poids') ?></th>
		<th><?php echo $paginator->sortableColumn('attack', 'Attaque') ?></th>
		<?php if($server->isRenewal): ?>
		<th><?php echo $paginator->sortableColumn('magic_attack', 'MATK') ?></th>
		<?php endif ?>
		<th><?php echo $paginator->sortableColumn('defense', 'Défense') ?></th>
		<th><?php echo $paginator->sortableColumn('range', 'Portée') ?></th>
		<th><?php echo $paginator->sortableColumn('slots', 'Slots') ?></th>
		<th><?php echo $paginator->sortableColumn('refineable', 'Raffinable') ?></th>
		<th><?php echo $paginator->sortableColumn('cost', 'En vente') ?></th>
	...
	<tr>
		...
		<td>
			<?php if ($item->refineable): ?>
				<span class="refineable yes">Oui</span>
			<?php else: ?>
				<span class="refineable no">Non</span>
			<?php endif ?>
		</td>
		<td>
			<?php if ($item->cost): ?>
				<span class="for-sale yes"><a href="<?php echo $this->url('purchase') ?>" title="Aller à la boutique">Oui</a></span>
			<?php else: ?>
				<span class="for-sale no">Non</span>
			<?php endif ?>
		</td>
		<td>
...
<?php else: ?>
	<p>Aucun objet trouvé. <a href="javascript:history.go(-1)">Retour</a>.</p>
	<?php if(Flux::config('Debug')): ?>
		<?php $msg = sprintf('Informations d’erreur : %s', print_r($sth->errorInfo(), true)); ?>
		<?php echo $msg; ?>
	<?php endif ?>
<?php endif ?>
