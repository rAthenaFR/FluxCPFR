	...
	<body>
		<table cellspacing="0" cellpadding="0" width="100%">
			...
			<tr>
				...
				<td style="padding: 10px"></td>
				<td width="100%">
					<!-- Boîte de connexion / informations utilisateur -->
						...
						<tr>
							...
							<td bgcolor="#f5f5f5">
								<?php if (Flux::config('DebugMode') && @gethostbyname(Flux::config('ServerAddress')) == '127.0.0.1'): ?>
									<p class="notice">Veuillez remplacer la directive <strong>ServerAddress</strong> dans la configuration par l’adresse reelle de votre serveur (ex. : monserveur.com).</p>
								<?php endif ?>
								...
								<!-- Solde de crédits -->
								<?php if (in_array($params->get('module'), array('purchase'))) include $this->themePath('main/balance.php', true) ?>
