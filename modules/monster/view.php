...
// Meme verification Renewal que pour les autres tables.
if($server->isRenewal) {
...
// Table des competences de monstres.
...
$col .= 'mvp_exp, ai, ';
$col .= implode(', ', $mode_list).', ';		// Liste des modes
...
if ($monster) {
	$title   = "Consultation de monstre ({$monster->name_english})";
