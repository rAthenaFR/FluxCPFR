...
if (count($_POST)) {
	//<input type="radio" name="whoto" id="whoto" value="1" checked="checked"> Personne<br />
	//<input type="radio" name="whoto" id="whoto" value="2"> Admins uniquement<br />
	//<input type="radio" name="whoto" id="whoto" value="3"> Equipe uniquement<br />
	//<input type="radio" name="whoto" id="whoto" value="4"> Tout le monde<br />
	...
	if(Flux::config('DiscordUseWebhook')) {
		if(Flux::config('DiscordSendOnMarketing')) {
			sendtodiscord(Flux::config('DiscordWebhookURL'), 'E-mail de masse envoye : '. $subject);
		}
	}
